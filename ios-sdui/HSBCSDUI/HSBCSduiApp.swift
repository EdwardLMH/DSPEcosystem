                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: Hive.Spacing.s6) {
                        ...
                        VStack(spacing: Hive.Spacing.s4) {
                            ...
                            JourneyCard(
                                icon: "💰",
                                badge: "Deposit Campaign CN",
                                title: "New Fund Deposit (CN)",
                                description: "SDUI-driven New Fund Deposit Campaign for Renminbi Savings: promo banner, time deposit rate table, open CTA and FAQ. Fetched live from mock BFF.",
                            ...
                            JourneyCard(
                                icon: "📊",
                                badge: "FX Viewpoint HK",
                                title: "FX Viewpoint — EUR & GBP (HK)",
                                description: "SDUI-driven market insight page: video briefing, key takeaways from HSBC FX Strategist, and Contact Your RM CTA. Fetched live from mock BFF.",
                                tags: ["SDUI", "Market Insight", "en-HK"],
                                accentColor: Color(hex: "#003366"),
                                action: { onSelect(.fxViewpoint) }
                            )

                            JourneyCard(
                                icon: "🪪",
                                badge: "OBKYC",
                                title: "OBKYC Account Opening",
                                description: "Full 11-step KYC journey: Personal Details → Identity Verification → Due Diligence → Open Banking → Declarations. Connects to mock BFF on port 4000.",
